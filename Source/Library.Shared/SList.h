...
#pragma region iterator
		...
		/**
		 * Gets the iterator preceeding end()
		 * Pairs well with InsertAfter an RemoveAfter
		 *
		 * @returns		the iterator preceeding end()
		 */
...
#pragma region Element Access
		 ...
		 * @throws std::out_of_range	if the container is empty
		 */
		[[nodiscard]] const reference Front() const;
		 ...
		 * @throws std::out_of_range	if the container is empty
		 */
		[[nodiscard]] const reference Back() const;
		 ...
		 * @throws std::out_of_range	if pos >= Size()
		 */
		[[nodiscard]] const reference At(size_type pos) const;
#pragma endregion
